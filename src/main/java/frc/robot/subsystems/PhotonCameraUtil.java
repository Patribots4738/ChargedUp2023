...
public class PhotonCameraUtil extends SubsystemBase {
    ...
    public Optional<EstimatedRobotPose> getEstimatedRobotPose() {
         ...
         * }
         * 
         * // If both cameras have results, and both cameras can see a target, compare
         * them
         ...
         * if (cam1Ambiguity < cam2Ambiguity && cam1Ambiguity <
         ...
         * if (cam1Pose.isPresent() && cam1Ambiguity <
         * VisionConstants.AMBIGUITY_THRESHOLD) {
         * return cam1Pose;
         * }
         * 
         ...
         * // * if it has low ambiguity
         * if (cam2Pose.isPresent() && cam2Ambiguity <
         * VisionConstants.AMBIGUITY_THRESHOLD) {
         * return cam2Pose;
         * }
         */
